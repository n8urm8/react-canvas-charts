...
import { renderChartLabel, type ChartLabelProps } from './InternalComponents/ChartLabel'
...
export const ChartValueLabels: React.FC<ChartValueLabelsProps> = ({ dataKey, ...labelProps }) => {
