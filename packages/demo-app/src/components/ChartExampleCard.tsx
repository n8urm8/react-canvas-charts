...
export const ChartExampleCard: React.FC<ChartExampleCardProps> = ({ title, description, chart, code }) => {
  ...
  return (
    <div className="relative perspective-1000">
      ...
      >
        {/* Front of card - Chart */}
        <div className="backface-hidden bg-white rounded-lg shadow-lg p-6">
          <div className="mb-4">
        ...
        {/* Back of card - Code */}
        <div className="absolute inset-0 backface-hidden bg-gray-900 rounded-lg shadow-lg p-6 rotate-y-180 flex flex-col min-h-[500px]">
          ...
          <div
            className="mt-4 text-center text-sm text-gray-400 cursor-pointer hover:text-gray-200 transition-colors py-2 flex-shrink-0"
