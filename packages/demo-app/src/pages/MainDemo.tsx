    ...
    <div className="max-w-5xl mx-auto p-8">
      <header className="mb-12">
        ...
        <p className="text-lg text-gray-600">
          High-performance canvas-based charting components for React applications.
          Built with TypeScript and optimized for real-time data visualization.
        </p>
      </header>
      ...
      <nav className="mb-12 p-6 bg-gray-50 rounded-lg">
        ...
        <ul className="space-y-2">
          <li><a href="#chart-surface" className="text-blue-600 hover:underline">ChartSurface</a> - Core chart container</li>
          <li><a href="#series" className="text-blue-600 hover:underline">Series Components</a> - Line, Area, and Point series</li>
          <li><a href="#axes" className="text-blue-600 hover:underline">Axes</a> - X and Y axis components</li>
          <li><a href="#layers" className="text-blue-600 hover:underline">Layers</a> - Grid, Cursor, Tooltip, Title, Value Labels</li>
          <li><a href="#controls" className="text-blue-600 hover:underline">Controls</a> - Legend and Toolbar</li>
        </ul>
      </nav>
        ...
        <div className="bg-gray-50 p-6 rounded-lg mb-4">
          ...
          <dl className="space-y-3">
            ...
            <div>
              ...
              <dd className="text-gray-700 ml-4">Array of property names for Y-axis values. Creates a series for each key.</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="text-gray-700 ml-4">Padding around the chart area. Can be number or object with top/right/bottom/left.</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="text-gray-700 ml-4">Define custom Y-axis scales with specific domain and data key mappings.</dd>
            </div>
            <div>
            ...
            <div>
              <dt className="font-mono text-sm text-blue-600">onSelectionChange?: (selection: ChartSelectionResult | null) =&gt; void</dt>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-4">
              ...
              <dl className="space-y-3">
                ...
                <div>
                  ...
                  <dd className="text-gray-700 ml-4">Use Catmull-Rom spline interpolation for smooth curves. Default: false</dd>
                </div>
                <div>
                ...
                <div>
                  ...
                  <dd className="text-gray-700 ml-4">Index for tracking multiple series. Used in cursor/tooltip logic.</dd>
                </div>
              </dl>
            </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-4">
              ...
              <dl className="space-y-3">
                ...
                <div>
                  <dt className="font-mono text-sm text-blue-600">shape?: "circle" | "square" | "triangle" | "diamond" | "cross" | "x"</dt>
      ...
      <section id="axes" className="mb-12">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Renders the horizontal axis with labels and tick marks.
            </p>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-4">
              ...
              <dl className="space-y-3">
                ...
                <div>
                  ...
                  <dd className="text-gray-700 ml-4">Maximum number of ticks to display. Auto-calculates step if needed.</dd>
                </div>
                <div>
      ...
      <section id="layers" className="mb-12">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Renders horizontal and vertical grid lines for easier value reading.
            </p>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-4">
              ...
              <dl className="space-y-3">
                ...
                <div>
                  ...
                  <dd className="text-gray-700 ml-4">Number of horizontal lines when not aligned with axis. Default: 5</dd>
                </div>
              </dl>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-4">
              ...
              <dl className="space-y-3">
                ...
                <div>
                  ...
                  <dd className="text-gray-700 ml-4">Snap to individual points (true) or all points at X position (false). Default: false</dd>
                </div>
                <div>
          ...
          <div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-4">
              ...
              <dl className="space-y-3">
                ...
                <div>
                  <dt className="font-mono text-sm text-blue-600">snapAlongYAxis?: boolean</dt>
                  <dd className="text-gray-700 ml-4">Show single point (true) or all series at X position (false). Default: false</dd>
                </div>
                <div>
                  <dt className="font-mono text-sm text-blue-600">seriesLabels?: Record&lt;string, string&gt;</dt>
                  <dd className="text-gray-700 ml-4">Custom labels for series keys (e.g., {`{ temp: "Temperature" }`}).</dd>
                </div>
                <div>
                  <dt className="font-mono text-sm text-blue-600">position?: "follow" | "fixed"</dt>
                  <dd className="text-gray-700 ml-4">Tooltip follows cursor or stays at fixed location. Default: "follow"</dd>
                </div>
                <div>
...
/>`}
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Renders a title text at the top or bottom of the chart.
            </p>
...
/>`}
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Renders value labels directly on or near data points.
            </p>
      ...
      <section id="controls" className="mb-12">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Displays a legend identifying each series with a color marker and label. Rendered as a DOM overlay (not canvas).
            </p>
...
/>`}
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Displays interactive tool buttons (e.g., zoom, pan, reset). Rendered as a DOM overlay with optional drag-to-reposition.
            </p>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-4">
              ...
              <dl className="space-y-3">
                ...
                <div>
                  ...
                  <dd className="text-gray-700 ml-4">Positioning with top/right/bottom/left (e.g., {`{ top: 16, left: 16 }`}).</dd>
                </div>
                <div>
                ...
                <div>
                  <dt className="font-mono text-sm text-blue-600">onToggle?: (tool, isActive, nextActiveIds) =&gt; void</dt>
...
/>`}
      ...
      <footer className="mt-16 pt-8 border-t-2 border-gray-200">
        ...
        <ul className="space-y-2 text-gray-700">
          ...
          <li>
            <a href="https://github.com/n8urm8/react-canvas-charts" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
              GitHub Repository
            </a>
        ...
        <div className="mt-8 p-4 bg-yellow-50 rounded-lg">
          ...
          <p className="text-gray-700">
            Bar chart components are currently under development and not included in this documentation. 
            Please use the line, area, and point series components for production applications.
          </p>
        </div>
      </footer>
    </div>
